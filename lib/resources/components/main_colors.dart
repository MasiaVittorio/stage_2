...
class StageMainColors<T> extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => StageBuild.offMainColors<T>(
        (_, singleColor, pageColors) {
...
class StageMainColorsPerPage<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StageBuild.offMainColors<T>(
      (_, __, pageColors) {
        ...
        final List<Widget> children = <Widget>[
          for (final page in pagesData.keys)
            ListTile(
              ...
              leading: ColorCircleDisplayer(
                pageColors[page!],
                icon: pagesData[page]!.icon,
              ),
  ...
  void pickPageColor(StageData<T, dynamic> stage, T page, Color? initialColor) => stage.pickColor(
        initialColor: initialColor,
        onSubmitted: (color) =>
            stage.themeController.currentColorsController.editMainPageToPrimary(page, color),
      );
}
...
class StageMainSingleColor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StageBuild.offMainColors(
      (_, singleColor, __) {
        final List<Widget> children = <Widget>[
          ListTile(

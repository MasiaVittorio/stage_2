...
extension StagePanelDataExt on _StagePanelData {
  ...
  CallbackScrollPhysics panelScrollPhysics() => CallbackScrollPhysics(
        topBounce: true,
  ...
  void onNextSnackBarClose(VoidCallback callback) => snackbarController.onNextSnackClose(callback);
  ...
  void _forgetPanelPage() {
    ...
    if (parent.popBehavior.rememberPanelPage != true &&

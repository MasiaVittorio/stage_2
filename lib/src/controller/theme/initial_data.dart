...
class StageThemeData<T, S> {
  ...
  StageThemeData<T, S> fillWith(StageThemeData<T, S>? other) => StageThemeData<T, S>._(
        ...
        backgroundColors:
            backgroundColors?.fillWith(other?.backgroundColors) ?? other?.backgroundColors,
  ...
  static const Map<StageColorPlace, double> defaultTopBarElevations = <StageColorPlace, double>{

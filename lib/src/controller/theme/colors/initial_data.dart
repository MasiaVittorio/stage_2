...
class StageColorsData<T, S> {
  ...
  final Map<T, Color>? lightMainPageToPrimary;

  ///could be null

  final Color? lightPanelPrimary;
  final Map<S, Color>? lightPanelPageToPrimary;
  ...
  final Map<DarkStyle, Map<T, Color>>? darkMainPageToPrimaries;

  ///could be null

  final Map<DarkStyle, Color>? darkPanelPrimaries;
  final Map<DarkStyle, Map<S, Color>>? darkPanelPageToPrimaries;
  ...
  StageColorsData._({
    ...
    required Map<DarkStyle?, Map<S, Color?>>? darkPanelPageToPrimaries,
        ...
        lightMainPageToPrimary = _getFullMapPages<T>(lightMainPageToPrimary, allMainPagesToFill),

        ///could be null
        lightPanelPrimary = lightPanelPrimary ?? lightMainPrimary ?? StageDefaultColors.primary,
        lightPanelPageToPrimary = _getFullMapPages<S>(lightPanelPageToPrimary, allPanelPagesToFill),
        ...
        darkMainPageToPrimaries =
            _getFullMapDarkPagesPrimaries<T>(darkMainPageToPrimaries, allMainPagesToFill),

        ///could be null
        darkPanelPrimaries = _getFullMapDarkPrimaries(darkPanelPrimaries),
        darkPanelPageToPrimaries =
            _getFullMapDarkPagesPrimaries<S>(darkPanelPageToPrimaries, allPanelPagesToFill);
  ...
  static StageColorsData<T, S> _fromThemeAndNullableData<T, S>(
    ...
    Iterable<S>? allPanelPagesToFill,
  ...
  static StageColorsData<T, S> _fromTheme<T, S>(
    ThemeData? theme, {
    Iterable<T>? allMainPagesToFill,
    Iterable<S>? allPanelPagesToFill,
    ...
    Map<DarkStyle, Map<S, Color?>>? darkPanelPageToPrimaries,
      ...
      StageColorsData<T, S>._(
        ...
        lightAccent: lightAccent ??
            ((theme == null) ? null : ((theme.isLight) ? theme.colorScheme.secondary : null)),
        lightMainPrimary: lightMainPrimary ??
            ((theme == null) ? null : (theme.isLight ? theme.primaryColor : null)),
        lightMainPageToPrimary: lightMainPageToPrimary,
        lightPanelPrimary: lightPanelPrimary ??
            (theme == null ? null : (theme.isLight ? theme.primaryColor : null)),
        ...
        darkAccents: darkAccents ??
            (theme == null
                ? null
                : (theme.isDark
                    ? DarkStyle.mapWithSingleValue<Color>(theme.colorScheme.secondary)
                    : null)),
        darkMainPrimaries: darkMainPrimaries ??
            (theme == null
                ? null
                : (theme.isDark ? DarkStyle.mapWithSingleValue<Color>(theme.primaryColor) : null)),
        darkMainPageToPrimaries: darkMainPageToPrimaries,
        darkPanelPrimaries: darkPanelPrimaries ??
            (theme == null
                ? null
                : (theme.isDark ? DarkStyle.mapWithSingleValue<Color>(theme.primaryColor) : null)),
  ...
  //================================
  // Static
  static Map<DarkStyle, Map<A, Color>>? _getFullMapDarkPagesPrimaries<A>(
      Map<DarkStyle?, Map<A, Color?>?>? provided, Iterable<A>? allPagesToFill) {
  ...
  static Map<A, Color>? _getFullMapPages<A>(Map<A, Color?>? provided, Iterable<A>? allPagesToFill) {
    ...
    Set<A> keys = <A>{
      if (allPagesToFill != null) ...allPagesToFill else ...provided.keys,
    };
    ...
    return <A, Color>{
      for (final A key in keys) key: provided[key] ?? validColor,
    };
  }

  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.removePadding(
      ...
      child: Container(
        ...
        child: pages._orderedPages.build(((_, orderedPages) => thCon.derived.panelPageToPrimaryColor
            .build(((_, primaryColorsMap) => thCon.derived._panelPrimaryColor
                .build(((_, currentColor) => pages._enabledPages.build(
                      ((_, enabled) => thCon.colorPlace.build(((_, place) => pages._page.build(
                          ((_, panelPage) => data.badgesController.panelPages.build((_, badges) {
                                ...
                                return RadioNavBar<S>(
                                  ...
                                  items: <S, RadioNavBarItem>{
                                    for (final entry
                                        in data.panelPagesController!.pagesData.entries)

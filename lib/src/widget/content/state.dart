...
class _StageContentState<T, S> extends State<_StageContent<T, S>> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    panelAnimation = AnimationController(
      ...
      duration: const Duration(milliseconds: 500),
        ...
        if (val >= widget.data.panelController.openedThreshold) {
          if (widget.data.panelController.isMostlyOpened.update(true)) {
            widget.data.panelController.snackbarController.close();
          }
        } else if (val < widget.data.panelController.closedThreshold) {
          widget.data.panelController.isMostlyOpened.update(false);
        }
      });
    ...
    widget.data.themeController.brightness._checkBrightness(context);
  ...
  Widget build(BuildContext context) {
    ...
    final Widget panelBackground = Positioned.fill(
      child: _PanelBackground(
            ...
            : data.dimensionsController.dimensions.build((_, dimensions) {
                Widget builder(BuildContext context, BoxConstraints constraints) {
                  ...
                  final Widget bottomNavBar = Positioned(
                    ...
                    /// This needs mediaQuery (derived dimensions) because of the bottom padding
                  ...
                  return SizedBox(
                    ...
                    child: Reactive.build2<bool, double?>(
                              ...
                              children: <Widget>[
                                ...
                                Positioned(
                                  ...
                                  bottom: derived.bottomBarSize // avoid the bottom bar
                                      ...
                                      clampedVal *
                                          derived
                                              .maxDownExpansion // expand down over the bottom bar while opening
                                      +
                                      (alert
                                          ? mediaQuery.viewInsets.bottom
                                          : 0.0), // make the panel avoid keyboard only if alert is shown,
                ...
                if (widget.wholeScreen) {
                  ...
                  return LayoutBuilder(
                    builder: (cont, constr) => ConstrainedBox(
                      constraints: constr,
    ...
    return data.themeController.derived.themeData.build(
      ((_, theme) => Theme(
            data: theme,

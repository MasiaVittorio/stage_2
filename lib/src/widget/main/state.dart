...
class _StageWithThemeAndExternalDataState<T, S>
    extends State<_StageWithThemeAndExternalData<T, S>> {
  ...
  void initState() {
    ...
    if (widget.controller != null) {
      ...
      final StagePagesData<S>? panelPages = StagePagesData._create<S>(
        manualNullable: widget.panelPages,
      ...
      controller = StageData<T, S>(
        ...
        initialDimensions:
            widget.dimensions ?? inherited?.dimensionsController.dimensions.value, // Could be null
        initialMainPagesData: mainPages,
        initialPanelPagesData: panelPages,
        ...
        popBehavior: widget.popBehavior,

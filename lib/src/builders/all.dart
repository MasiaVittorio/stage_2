...
class StageBuild {
  ...
  static Widget offPrimaryColorAndItsBrightness(
          Widget Function(BuildContext, Color?, Brightness) builder) =>
  ...
  static Widget offOpenNonAlertAndPages<T, S>(
          Widget Function(BuildContext context, bool openNonAlert, T? mainPage, S? panelPage)
              builder) =>
      _StageBuildOffOpenNonAlertAllPages<T, S>(builder);

  static Widget offMainPagesData<T>(
          Widget Function(BuildContext, Map<T, bool>, List<T>, T) builder) =>
  ...
  static Widget offPanelPagesData<S>(
          Widget Function(BuildContext, Map<S?, bool>, List<S?>, S) builder) =>

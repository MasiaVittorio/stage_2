...
class Snacks extends StatelessWidget {
  ...
  static const Widget scroll = StageSnackBar(
    title: Text("Swipe me away!"),
    scrollable: true,
  );
  static const Widget subtitle = StageSnackBar(
    title: Text("Title"),
    scrollable: true,
    subtitle: Text("Subtitle"),
  );
  static const Widget secondary = StageSnackBar(
    title: Text("Title"),
    scrollable: true,
    subtitle: Text("Subtitle"),
...
class _SelectorState extends State<Selector> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget snack = SelectSnackbar(
      ...
      children: <Widget>[
        for (final icon in icons) Icon(icon),
      ],
      onTap: (i) {
        setState(() {
          selected = i;
